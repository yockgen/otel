...
grafana_api.dashboard.update_dashboard(dashboard={'dashboard': {'tags':['test02'],'refresh':'5s', 'title': 'Test Intel 02','type':'dash-db','panels':pnl_config}, 'folderId': 0, 'overwrite': True})
